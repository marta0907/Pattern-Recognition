...
figure(9);
hold on;
title('NN classifier of Class A and Class B');


y = min_x_ab-1:0.05:max_x_ab+1;
x = min_y_ab-1:0.05:max_y_ab+1;

Z = KNN(1,samples_a,samples_b,x,y);
...
figure(10);
hold on;
title('NN classifier of Class C, Class D and Class E');
xlabel('x_1');
ylabel('x_2');
...
Z = KNN_3(1,samples_c,samples_d, samples_e,x,y);
dis1 = KNN_dist(5,samples_c,17,23);
dis2 = KNN_dist(5,samples_d,17,23);
dis3 = KNN_dist(5,samples_e,17,23);
